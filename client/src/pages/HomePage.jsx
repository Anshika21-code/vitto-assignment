...
//     height: 350,
//     background:
//       "radial-gradient(ellipse, rgba(211,47,47,0.15) 0%, transparent 70%)",
//     filter: "blur(60px)",
//     pointerEvents: "none",
//     zIndex: 0,
//   }}
    ...
    >
      ...
      <div
        style={{
          ...
          height: 350,
          background:
            "radial-gradient(ellipse, rgba(211,47,47,0.10) 0%, transparent 70%)",
          filter: "blur(60px)",
          pointerEvents: "none",
          zIndex: 0,
        }}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {[
                      40, 65, 45, 80, 55, 90, 60, 75, 50, 85, 70, 95, 65, 88, 72,
                    ].map((h, i) => (
                      <div
                        key={i}
                        style={{
  ...
  const stats = [
    {
      ...
      sub: "Median time from 18 min to under 5 min",
    },
    {
      value: "40%",
      label: "Reduction in portfolio NPA",
      sub: "Through predictive early-warning signals",
    },
    {
      value: "28%",
      label: "Higher recovery rates",
      sub: "With propensity-scored collection workflows",
    },
    {
      value: "60+",
